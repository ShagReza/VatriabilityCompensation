# -*- coding: utf-8 -*-
"""
Created on Sat Feb  6 15:17:57 2021
...
y = Dense(103, activation="linear",name='v6')(x)
output = [x,y]
model=Model(input_tensor, output)
model.summary()
opt1 = optimizers.Adam(lr=0.002, beta_1=0.9, beta_2=0.999, epsilon=1e-08, decay=0.0)
model.compile(loss={'v6': 'mean_squared_error', 'v5': 'mean_squared_error'},
              loss_weights={'v6': 0.8, 'v5': 0.2},
              optimizer=opt1)
for k in range(40):
    #------------------------------------------------------------------------------    
    # Find best landmarks

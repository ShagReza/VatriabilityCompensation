...
#val:
CB_total_val= scipy.io.loadmat(path+'\CB_total_test.mat')
x_val=CB_total_val['CB_total_test']
LBL_total_val = scipy.io.loadmat(path+'\LBL_total_test.mat')
y_val=LBL_total_val['LBL_total_test']
...
# train model  
history = model.fit(x_train, [CbOut,y_train], batch_size=128, epochs=100, shuffle=True, verbose=1,
...
model = load_model('D:\Shapar\ShaghayeghUni\AfterPropozal\Step1-EventLandmark\Programs\MyPrograms\EventExtraction\Keras\model\model_epoch_08.hdf5')
